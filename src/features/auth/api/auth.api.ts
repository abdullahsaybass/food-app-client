...
export const googleAuthApi = async (data: GoogleAuthInput): Promise<AuthResponse> => {
...
export const forgotPasswordApi = async (email: ForgotPasswordInput): Promise<BasicResponse> => {
  const res = await API.post('/auth/forgot-password', { email });
  return res.data;
};

export const resetPasswordApi = async (data: ResetPasswordInput): Promise<BasicResponse> => {
